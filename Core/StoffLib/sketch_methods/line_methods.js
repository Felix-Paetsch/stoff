...
} from "../unicorns/intersect_lines.js";
import {
...
export default (Sketch) => {
    ...
    Sketch.prototype.line_at_angle = function (
        point,
        angle,
        length,
    ...
    Sketch.prototype.line_from_function_graph = function (
        pt1,
        pt2,
        f_1,
        f_2 = null
        ...
        const transform_target = [new Vector(0, 0), new Vector(1, 0)];
    ...
    Sketch.prototype.merge_lines = function (
        line1,
        line2,
        delete_join = false,
    ...
    Sketch.prototype.point_on_line = function (
        ...
        return this.object_to_sketch_element_collection(
            {
                line_segments:
                    this.make_sketch_element_collection(line_segments),
                point: pt,
            },
            [pt],
            line_segments,
    ...
    Sketch.prototype.split_line_at_length = function (
        line,
        length,
        data_callback = copy_data_callback,
        reversed = false
    ...
    Sketch.prototype.split_line_at_fraction = function (
        line,
        fraction,
        data_callback = copy_data_callback,
        reversed = false
    ...
    Sketch.prototype.intersect_lines = function (line1, line2) {
        ...
        */
        ...
        return this.object_to_sketch_element_collection(
            {
                intersection_points:
                    this.make_sketch_element_collection(intersection_points),
    ...
    Sketch.prototype.intersection_positions = function (line1, line2) {
        ...
        if (line1 instanceof PlainLine || line1 instanceof Ray) {
            return this.intersection_positions(line2, line1);
        }

        if (line2 instanceof PlainLine || line2 instanceof Ray) {
            assert.IS_LINE(line1);
            assert.HAS_SKETCH(line1, this);

            return plainLine_intersection_positions(line1, line2);
        }

        assert.THROW("Wrong inputs!");
    };

    Sketch.prototype.copy_line = function (
        line,
        from = null,
        to = null,
        data_callback = copy_data_callback
