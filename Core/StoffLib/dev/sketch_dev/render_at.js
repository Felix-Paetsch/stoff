...
export default (Sketch) => {
    ...
    Sketch.dev.to_html = function (...args) {
        try {
            ...
            throw new Error(
                "Can't find assets. Perhaps DevServer is not connected!"
            );
        }
    };

    Sketch.dev.save_as_html = function (
        path,
        title = "/StoffLib",
        data = null
    ) {
