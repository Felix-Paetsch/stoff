...
export default function register_collection_methods(Class) {
    ...
    Class.prototype.to_sketch_element_collection = function () {
        return this.make_sketch_element_collection(this.get_sketch_elements());
    };

    Class.prototype.object_to_sketch_element_collection = function (
        obj,
        points = null,
        lines = null,
        sketch = null
        ...
        const r = new SketchElementCollection(
            [...(points || obj.points || []), ...(lines || obj.lines || [])],
            sketch || this.get_sketch(true)
        );
