...
export default class DartData{
    ...
    #eval_darts() {
        ...
        this.darts.forEach(dart => {
            ...
            if (!Object.keys(this.lines).includes(dart.line)){
                this.lines[dart.line] = [[dart.fraction_along_line, dart.dart_amount]];
            } else {
                this.lines[dart.line].push([dart.fraction_along_line, dart.dart_amount]);
            }
        });
    }
    ...
    sort_line(line){
        this.lines[line].sort(function (a, b) { return a[0] - b[0] });
    }
