...
// percent of 
    cut_length(percent){
        ...
        let len = (1-percent) * (0.6 * (this.wd.sh.center + this.wd.sh.waist_height));
        ...
        lns.forEach(ln => {
            ...
            let temp1 = this.sketch.intersect_lines(ln.p1.other_adjacent_line(ln), ln_h);
            
            this.sketch.dev.at_new_url("/bla")
            
            let temp2 = this.sketch.intersect_lines(ln.p2.other_adjacent_line(ln), temp1.l2_segments[1]);
            
            this.sketch.remove(temp1.l2_segments[0].p1, temp2.l2_segments[1].p2);
