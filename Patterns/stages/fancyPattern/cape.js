...
export default class CapeStage extends SequentialStage {
    ...
    construct_cape() {
        if (this.wd.side == "front") {
            ...
            this.#open_armpit();
            this.wd.front_neckline_length = this.sketch
                .get_typed_line("neckline")
                .get_length();
        } else {
            this.#cut_short(0.1);
            this.#remove_front_gapping(0.04);
            this.#open_armpit();
            this.wd.back_neckline_length = this.sketch
                .get_typed_line("neckline")
                .get_length();
        }
    }
    ...
    #construct_special_bottom_part() {
        ...
        // small part
        const bottom_2 = comp2
            .get_lines()
            .filter((ln) => ln.data.type == "bottom")[0];
        vec = bottom_2.p1
            .other_adjacent_line(bottom_2)
            .get_line_vector()
            .scale(0.75);
        ...
        const sides_3 = comp3
            .get_lines()
            .filter((ln) => ln.data.type == "side");
        vec = sides_3[1].p1
            .other_adjacent_line(sides_3[1])
            .get_line_vector()
            .scale(scale);
