...
export default (design_config) => {
    ...
    let wd2 = main_pattern_construction(
        measurements,
        design_config,
        "front"
    );
    wd.sketch.data = design_config;
      return main_sleeve_construction(wd, design_config).sketch.paste_sketch(wd.sketch, null, new Vector(-81, -12.5)).paste_sketch(wd2.sketch);
