...
export class BoundingBox {
        ...
        return BoundingBox.from_points(
            boxes
                ...
                .flatMap((b) => [
                    b.actual_top_left,
                    b.actual_top_right,
                    b.actual_bottom_left,
                    b.actual_bottom_right,
                ]),
            min_bb!,
        );
    }
    ...
    get top_left() {
        return new Vector(
            this.min_x -
                adjust_for_minimial_bb(this.min_bb[0], this.actual_width),
            this.min_y -
                adjust_for_minimial_bb(this.min_bb[1], this.actual_height),
        );
    }
