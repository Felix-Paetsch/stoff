...
// https://docs.rs/retworkx/latest/src/retworkx/max_weight_matching.rs.html
//
        ...
        for nblist in nblists {
            for edge_index in nblist {
                ...
                if blossom_j != blossom
                    ...
                    && (!best_edge_to.contains_key(&blossom_j)
...
pub fn max_weight_matching(
    ...
    for edge in graph.edge_references() {
        let edge_weight: i128 = *edge.weight();
    ...
    for _ in 0..num_nodes {
        ...
        for v in 0..num_nodes {
            if !mate.contains_key(&v) && labels[in_blossoms[v]] == Some(0) {
                assign_label(
                    v,
                    1,
                    None,
