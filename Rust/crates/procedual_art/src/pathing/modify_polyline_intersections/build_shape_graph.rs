use geometry::{
    ...
    intersections::find_shape_self_intersections,
};
use petgraph::unionfind::UnionFind;
use std::collections::HashMap;

use crate::pathing::modify_polyline_intersections::types::{ShapeGraph, ShapeGraphEdge};
    ...
    let mut with_key: Vec<(usize, f64)> = edges
        ...
        .map(|(index, edge)| {
            ...
            for vector in subshape.iter().skip(1) {
                ...
                return (index, Vector::angle_clockwise(right, *vector - start));
            }
