...
export default (Class, set_if_not_exists) => {
    set_if_not_exists(Class, "connected_component", function(sketch_el = null){
    ...
    set_if_not_exists(Class, "get_connected_components", function(){
        ...
        while (points.length > 0){
            ...
            while (to_visit_points.length > 0){
                ...
                const possible_next_lines = currently_visiting_point.get_adjacent_lines().get_common_lines(lines);
