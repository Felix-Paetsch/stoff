async function add_new_point() {
    ...
    try {
        ...
        const response = await fetch(
            `${frontend_vars.website_path}/requests/create_point`,
            {
                method: "POST",
        ...
        const newCard1 = create_point_card(
            point_name,
            point_id,
            point_color,
            false,
        );
        const newCard2 = create_point_card(
            point_name,
            point_id,
            point_color,
            true,
        ...
        console.log(
            `Created new imageset with name ${point_name} and ID ${point_id}`,
        );
