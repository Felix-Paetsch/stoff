...
export function main_pattern_construction(mea, design_data, side){
    ...
    if(side == "front"){
      ...
      design_data.basic.fabric_adjustment_needed = design_data.front.fabric_adjustment_needed
    } else {
      needed_base_type = design_data.back.base_type;
      design_data.basic.fabric_adjustment_needed = design_data.back.fabric_adjustment_needed
    }

    design_data.front.additional.manipulation_distance = (mea.bust_point_width / 2 ) * 0.85;
    design_data.back.additional.manipulation_distance = (mea.shoulderblade_width / 2 ) * 0.85;
...
export function main_sleeve_construction(wd, design_data){
    ...
    switch (design_data.sleeve.type) {
        ...
        case "slim":
            ...
            break;
        case "extra slim":
            sleeve.slim_sleeve(wd.measurements.arm - wd.measurements.wristwidth);
            sleeve.cut_length(design_data.sleeve.length);
            break;
        case "casual":
        ...
        case "flared":
            ...
            if(!design_data.sleeve.additional.flare_distance){
              ...
              sleeve.flare_bottom_sleeve(design_data.sleeve.additional.flare_distance, true);
            }
            sleeve.connect_sleeve_bottom(4);
            break;
        case "ruffles":
