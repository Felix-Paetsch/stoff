use crate::{
    ...
    closest::closest_point_on_linesegment,
...
pub fn closest_point_on_shape_with_length_map(
    ...
    closest_point_on_shape_with_length_map_recursion(
        shape,
        LengthRecursionData::new(shape, lengths, |v| Vector::distance(point, v)),
        f64::INFINITY,
        point,
    )
}

pub(crate) fn closest_point_on_shape_with_length_map_recursion(
    shape: &impl ShapeT,
