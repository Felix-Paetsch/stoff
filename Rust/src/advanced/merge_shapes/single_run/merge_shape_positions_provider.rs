...
use crate::{
    advanced::merge_shapes::shared::{MergePosition, ShapeEndpoint, ShapeEndpointPairDatum},
    geometry::{
        Shape, ShapeT, Vector,
        algorithms::closest::{LazyClosestShapePositions, ShapeDistanceDatum},
    },
    graph::{
        algorithms::minimum_weight_perfect_matching::min_weight_matching_f64,
