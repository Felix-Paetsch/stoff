...
export function wrap_sketch_methods(
    s: Sketch,
    method: (evaluate: () => EvaluationResult, s: Sketch, fn_name: string, args: any[]) => EvaluationResult,
    wrap_on: null | (MethodName<Sketch>)[] = null
): Toggle {
    return wrap_object_methods<Sketch>(s, method, wrap_on || sketch_graphical_non_pure_methods);
}
...
export function wrap_sketch_prototype_methods(
    ...
    return wrap_class_prototype_methods<Sketch>(s, method, wrap_on || sketch_graphical_non_pure_methods);
}
