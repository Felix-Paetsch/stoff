...
use crate::geometry::{Geometry, Polygon, Polyline, ShapeT, Vector};
...
pub fn copy_shape_into_geo_polygon(s: &impl ShapeT) -> geo::Polygon {
    geo::Polygon::new(copy_shape_into_geo_linestring(s), vec![])
}

pub fn copy_shape_into_geo_linestring(s: &impl ShapeT) -> geo::LineString {
